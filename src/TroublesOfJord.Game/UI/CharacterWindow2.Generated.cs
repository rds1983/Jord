/* Generated by MyraPad at 8/11/2020 12:05:02 PM */
...
namespace TroublesOfJord.UI
{
	partial class CharacterWindow: Window
	{
		private void BuildUI()
		{
			...
			grid2.RowSpacing = 8;
			grid2.Widgets.Add(_labelHp);
			grid2.Widgets.Add(_labelEnergy);
			grid2.Widgets.Add(_labelAc);
			grid2.Widgets.Add(_labelHit);

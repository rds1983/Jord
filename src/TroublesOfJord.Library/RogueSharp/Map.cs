...
namespace RogueSharp
{
	...
	public class Map<TCell> : IMap<TCell> where TCell : ICell
	{
		...
		public FieldOfView<TCell> FieldOfView { get; private set; }
		...
		private void Init(int width, int height)
		{
			...
			FieldOfView = new FieldOfView<TCell>(this);
		}
		...
		{
			return _cells[x, y].Info.IsTransparent;
		}
		...
		{
			return _cells[x, y].Info.IsWalkable;
		}
		...
		public void SetCellInfo(int x, int y, ICellInfo info)
		{
			if (info == null)
			{
			...
			_cells[x, y].Info = info;
		}

		public void Clear(ICellInfo info)
		{
			if (info == null)
			{
				throw new ArgumentNullException(nameof(info));
		...
		public void Restore(MapState state)
		{
			...
			FieldOfView = new FieldOfView<TCell>(this, inFov);
		}

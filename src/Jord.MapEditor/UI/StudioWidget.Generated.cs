/* Generated by MyraPad at 4/10/2023 7:28:45 PM */
using Myra;
...
namespace Jord.MapEditor.UI
{
	partial class StudioWidget: Grid
	{
		private void BuildUI()
		{
			...
			_generateMapMenuItem = new MenuItem();
			_generateMapMenuItem.Text = "&Generate Map...";
			_generateMapMenuItem.ShortcutText = "Ctrl+G";
			_generateMapMenuItem.Id = "_generateMapMenuItem";
			...
			menuItem1.Items.Add(_generateMapMenuItem);
		...
		public MenuItem _generateMapMenuItem;

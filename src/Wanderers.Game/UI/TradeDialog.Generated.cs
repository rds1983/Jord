/* Generated by MyraPad at 17.10.2019 22:30:34 */
...
namespace Wanderers.UI
{
	partial class TradeDialog: Dialog
	{
		private void BuildUI()
		{
			...
			grid1.Widgets.Add(scrollViewer1);
			...
			_gridGoldTransfer.DefaultRowProportion = new Proportion
			{
				Type = Myra.Graphics2D.UI.ProportionType.Auto,
			};
			...
			grid2.Widgets.Add(scrollViewer2);

	...
	public partial class TradeDialog: Dialog
	{
		...
		private void Update()
		{
			...
			else
			{
				...
				_textGoldTransfer.Text = Wanderers.Resources.TextGold +  ": " + Math.Abs(_leftToRightGoldTransfer).ToString();
		...
		protected override bool CanCloseByOk()
		{
			...
			var msg = CreateMessageBox(Wanderers.Resources.TextNotEnoughGold, Wanderers.Resources.TextNotEnoughGold);
			msg.ShowModal();
